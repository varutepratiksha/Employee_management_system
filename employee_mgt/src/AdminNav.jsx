...
export default function AdminNav() {
  ...
  return (
    <div>
     <nav className="navbar navbar-expand-lg navbar-warning bg-info">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <Link to="/updateleavestatus" className="nav-link">
                  Update Leave Status
                </Link>
              </li>
              <li class="nav-item">
              ...
              {/* <li class="nav-item">
                  <Link to="/leaveapplication" className='nav-link'>Leave Application</Link>
                </li>
                <li class="nav-item">
